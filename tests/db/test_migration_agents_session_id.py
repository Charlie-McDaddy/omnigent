...
def test_agents_session_id_fk_rejects_missing_session(db_engine: Engine) -> None:
    ...
    with db_engine.begin() as conn:
        conn.execute(
            sa.text(
                "DELETE FROM agent_configuration WHERE conversation_id = '5eca720dc2bc6cdc3a99028d7bd0f917'"
            )
        )
        conn.execute(
    ...
    with raw_engine.begin() as conn:
        conn.execute(
            sa.text(
                ...
                " VALUES ('23803e78ca1677e73a1d8c6275de4150', 1, 'my-template', '23803e78ca1677e73a1d8c6275de4150/b', 1),"
                "        ('372d0296768feff7262c605c5553d1da', 2, 'my-session', '372d0296768feff7262c605c5553d1da/b', 1)"
            )
        )
        conn.execute(
            sa.text(
    ...
    with raw_engine.begin() as conn:
        ...
        conn.execute(
            sa.text(
                ...
                " VALUES (0, '8e32600337d08f59ad381caf96a90659', 3, 3, '8e32600337d08f59ad381caf96a90659', '')"
            )
        )
        ...
        conn.execute(
            sa.text(
                ...
                " VALUES (0, '8e32600337d08f59ad381caf96a90659', '372d0296768feff7262c605c5553d1da')"
            )
        )
